// room18.js — ROOM 18: a side room of the haveli, reached via a corridor
...
// doorX: the x coordinate where room18's east wall (and doorway) sits —
// this is corridor20.endX, so the door lines up exactly with the passage.
// doorZ: the z coordinate of the doorway, matching the corridor's z (room4's west door).
export function createRoom18(scene, engine, doorX, doorZ) {
  const colliders = [];
  ...
  // south wall — doorway gap in the middle, aligned with the corridor to room19
  ...
  // corridor.js's createCorridorSouth starts here and runs further south toward room19.
