...
//
// Also holds "book1", one of the four collectible storybooks (see books.js)
...
export function createRoom8(scene, engine, doorZ, doorX) {
  ...
  // ---------- collectible: book1 ----------
  // Tucked in the south-east corner of this dead-end room, away from the doorway.
  addBookPickup(
    scene,
    engine,
    { x: centerX + 1.6, y: 0.05, z: centerZ + 1.8 },
    "book1",
    "Weathered Diary"
  );
